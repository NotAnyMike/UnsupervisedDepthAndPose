...
parser.add_argument('--continue_training', action='store_true',
        help="Whether or not start from checkpoint, if init_checkpoint_file \
                is None then the last checkpoint is taken")
...
parser.add_argument('--exp_regularization_weight', default=0.0, type=float,
